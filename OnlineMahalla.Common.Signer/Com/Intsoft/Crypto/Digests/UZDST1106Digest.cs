using Com.Intsoft.Crypto.Ciphers;
using Com.Intsoft.Crypto.Parameters;
using Com.Intsoft.Crypto.Utilities;
using Com.Intsoft.Utilities;

namespace Com.Intsoft.Crypto.Digests
{
	/**
	* implementation of UZDST 1106
	*/
	public class UZDST1106Digest
		: IDigest
	{
		...
		private readonly IBlockCipher cipher = new Gost28147Cipher();
		 ...
		 */
		public UZDST1106Digest()
		{
			sBox = Gost28147Cipher.GetSBox("D-A");
		 ...
		 */
		public UZDST1106Digest(byte[] sBoxParam)
		{
		 ...
		 * message digest.
		 */
		public UZDST1106Digest(UZDST1106Digest t)
		{
			this.sBox = t.sBox;
			cipher.Init(true, new ParametersWithSBox(null, sBox));
