...
namespace OnlineMahalla.Web.MVCClient.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        public EmployeeController(IDataRepository dataRepository, IStringLocalizer<EmployeeController> localizer, Microsoft.AspNetCore.Http.IHttpContextAccessor httpContextAccessor, IWebHostEnvironment hostingEnvironment)
        {
        ...
        {
            var data = _dataRepository.GetEmployeeList(Name, Search, Sort, Order, Offset, Limit);
